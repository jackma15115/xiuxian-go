  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: 'game', to: 'game', noErrorOnMissing: true },
        { from: 'game_bhz', to: 'game_bhz', noErrorOnMissing: true },
        { from: 'game_xiandai', to: 'game_xiandai', noErrorOnMissing: true },
        { from: 'game_acjt', to: 'game_acjt', noErrorOnMissing: true },
      ],
    }),
  ],
};
